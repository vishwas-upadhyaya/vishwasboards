...
class BoardTopicsTests(TestCase):
    def setUp(self):
        Board.objects.create(name='Django',description='about django')
...
class NewTopicTests(TestCase):
    def setUp(self):
        Board.objects.create(name='Django',description='about Django')
        User.objects.create_user(username='hritesh',email='hritesh2727@gmail.com',password='12345678')
